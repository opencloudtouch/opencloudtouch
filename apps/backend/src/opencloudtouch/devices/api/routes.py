...
async def rename_device(
    ...
    try:
        ...
        logger.error("SSH rename failed for %s: %s", device_id, e)  # device_id is MAC-validated; e is exception (safe)
        raise HTTPException(
    ...
    logger.info("Device %s renamed: %r -> %r", device_id, previous_name, name)
