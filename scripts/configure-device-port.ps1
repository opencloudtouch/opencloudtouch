...
.PARAMETER DeviceIP
    IP address of the SoundTouch device (default: 192.168.178.79)

.PARAMETER StreamingURL
    Base URL for streaming service (default: http://streaming.bose.com:7777)

.EXAMPLE
    .\configure-device-port.ps1 -DeviceIP 192.168.178.79 -StreamingURL "http://streaming.bose.com:7777"
#>

param(
    [string]$DeviceIP = "192.168.178.79",
